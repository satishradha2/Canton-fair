  ...
  Future<void> _apply() async {
    ...
    try {
      final path = await _channel.invokeMethod<String>('crop', {
        'path': _preview,
        'corners': _corners.map((p) => [p.dx, p.dy]).toList(),
      });
        ...
        child: Scaffold(
          ...
          body: SafeArea(
            ...
            Expanded(child: LayoutBuilder(builder: (context, bounds) {
              ...
              final width =
                  math.min(bounds.maxWidth, bounds.maxHeight * _ratio);
                  ...
                  child: SizedBox(
                      ...
                      child: GestureDetector(
                        ...
                        child: Stack(fit: StackFit.expand, children: [
                          ...
                          CustomPaint(
                              painter: _Outline(List<Offset>.from(_corners))),
                        ]),
                      )));
            })),
            Padding(
